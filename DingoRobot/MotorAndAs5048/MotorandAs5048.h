...
#define LeftMotorBrake    4  //  D4 - left  motor brake        control    pin    HIGH = Brake #define LeftMotorDire     2  //  D2 - left  motor direction    control    pin    HIGH = Forward   Low = Reverse
